                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    ...
                                    <p class="text-sm">Informcaión de los clientes</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    ...
                                    <button type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                                        ...
                                        <span class="btn-inner--text">Añadir cliente</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body px-0 py-0">
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7">Nombres
                                            </th>
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">
                                                Apellidos</th>
                                            <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">
                                                Tiempo con nosotros</th>
                            ...
                            <div class="border-top py-3 px-3 d-flex align-items-center">
                                <p class="font-weight-semibold mb-0 text-dark text-sm">Pagina 1 de 10</p>
                                <div class="ms-auto">
